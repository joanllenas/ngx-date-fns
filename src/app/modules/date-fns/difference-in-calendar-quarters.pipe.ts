...
import * as differenceInCalendarQuartersNs from 'date-fns/difference_in_calendar_quarters';
const differenceInCalendarQuarters = differenceInCalendarQuartersNs;
